...
// CGSIsSymbolicHotKeyEnabled is no longer an experiment; it lives next to CGSSetSymbolicHotKeyEnabled
// in SkyLight.framework.swift, where restoreNativeHotkeys uses it
