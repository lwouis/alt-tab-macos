...
typealias NotifyCallback = @convention(c) (_ type: UInt32, _ data: UnsafeRawPointer?, _ dataLength: Int, _ context: UnsafeMutableRawPointer?, _ cid: CGSConnectionID) -> Void

@_silgen_name("SLSRegisterConnectionNotifyProc")
func SLSRegisterConnectionNotifyProc(_ cid: CGSConnectionID, _ callback: NotifyCallback, _ event: NotifyEvent.RawValue, _ context: UnsafeMutableRawPointer?) -> CGError
...
/// ---
/// subscribe to internal window notifications. This requires a prior call to SLSRegisterConnectionNotifyProc to pick the type of notifications
/// windowList size is limited to 1024
@_silgen_name("SLSRequestNotificationsForWindows")
func SLSRequestNotificationsForWindows(_ cid: CGSConnectionID, _ windowList: UnsafeMutablePointer<CGWindowID>, _ windowCount: Int) -> CGError
